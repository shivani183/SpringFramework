...
public class CustomerMySQLDAOImpl implements ICustomerDAO {
	...
	private static final String REALTIMEDI_CUSTOMER_INSERT_QUERY = "insert into customer(`cname`,`caddr`,`pamt`,`time`,`rate`,`intrAmt`)values(?,?,?,?,?,?)";
